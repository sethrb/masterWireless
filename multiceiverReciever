...
double gotByte[4] = {0,0,0,0}; //used to store payload from transmit module
...
void niceSerial(byte transmitter) {
  Serial.print("Transmitter: "); 
  Serial.println(transmitter); //print which pipe or transmitter this is from
  Serial.print("Temperature: ");
  Serial.print(gotByte[0]); //print payload or the number the transmitter guessed
  Serial.print("  Light:");
  Serial.print(gotByte[1]);
  Serial.print(" Humidity:");
  Serial.print(gotByte[2]);
  Serial.print(" Other info:");
